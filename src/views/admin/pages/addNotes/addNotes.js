...
class addNotes extends Component {
    ...
    addNews(status){
        React.axios.post('/usr/api/admin/proclamationManage/saveProclamationManage',{
            ...
            if(res.data.messageCode === '1000'){
                Message('添加成功!')
                this.props.history.push('/admin/noticeManage')
            }
        })
    }
    render() {
        return (
            <div className={'admin_addNotes'}>
                <div>
                    ...
                    <div className={'btn'}>
                        ...
                        {/*<a>预览</a>*/}
                        <a onClick={()=>{this.props.history.push('/admin/noticeManage')}}>取消</a>
                    </div>
                </div>
            </div>
        )
